...
class GarnetQueue implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $leadID = $data['leadID'];
        $phone = $data['phone'];
        $responseUrl = 'https://icredit-crm.kz/api/webhock/cronResponseGarnet.php?leadID=' . $leadID . '&phone=' . $phone.'&iin=' . $iin . '&';
        if (isset($result['terror']) && $result['terror'] == true) {
            $responseUrl .= 'otkazId=10411&message=5';
        }
